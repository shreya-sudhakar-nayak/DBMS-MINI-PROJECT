...
$query = "SELECT NAME, UID, EMAIL, PH_NO FROM user";
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-12 nav-img">
                         <div style="float:left; padding:10px; color:white; background-color:#32a8ed ;font-weight:bold"  onclick="goToNextPage2()">Login/Signup</div>
                    ...
                    <div id="menu" class="col-md-9 d-none d-md-block nav-item">
                        <ul>
                            ...
                            <li><a href="admin_message.html">Messages</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12">
                    ...
                    <ul class="list-unstyled link-list">
                        ...
                        <li><a ui-sref="services" href="about_services.html">Services</a><i class="fa fa-angle-right"></i></li>
                    </ul>
                </div>
