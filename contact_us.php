...
<!-- ################# Header Starts Here#######################--->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 col-md-12 left-item">
                        <ul>
                            <li><i class="fas fa-envelope-square"></i> contact@stellarshine.com</li>
    ...
    <!-- ######## Page  Title End ####### -->
      ...
      <div style="margin-top:0px;" class="row no-margin" align="center">
        ...
        <div class="container">
           <div class="row">
            ...
            <h2 style="font-size:18px">Contact Form</h2>
                <div class="row">
                    <div style="padding-top:10px;" class="col-sm-3"><label>Enter UserId :</label></div>
    ...
    Email: info@stellarshine.com<br>
    Web: www.stellarshine.com<br>   
...
// Function to generate unique CID
function generateCID($conn) {
    $cid = "cd" . rand(100, 999);

    // Check if the generated ID already exists in the database
    $checkQuery = "SELECT CID FROM contact WHERE CID = '$cid'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_insert = "INSERT INTO contact(UID,CID,MESSAGE,STATUS,C_DATE) VALUES('$userID','$cid','$message','Delivered','$current')";
